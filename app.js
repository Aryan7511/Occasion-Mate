...
app.post("/venue-login", async function (req, res) {
  try {
    ...
    try {
      check = await Venue.findOne({
        owner_email: req.body.email.toLowerCase(),
      });
    } catch (err) {
      console.log(err);
    }
...
app.get(
  "/admin-dashboard/:adminId/vendor",
  adminsessionCheck,
  async function (req, res) {
    const UserID = req.params.adminId;
...
app.get(
  "/user-dashboard/:userId/active-events",
  sessionCheck,
  async function (req, res) {
    const UserID = req.params.userId;
...
app.get(
  "/user-dashboard/:userId/vendor-enquiries",
  sessionCheck,
  async function (req, res) {
    const UserID = req.params.userId;
    ...
    res.render("userDashboardVendorPage", {
      UserID: UserID,
      enquiries: enquiries,
    });
  }
...
app.get(
  "/user-dashboard/:userId/venue-enquiries/:enquirieId/pay",
  sessionCheck,
  async function (req, res) {
    ...
    try {
      user = await VenueDashboard.findOne({
        userID: UserID,
    ...
    res.render("userDashboardVenueBillPage", {
      VenueID: venue._id,
      event: event,
      venue: venue,
      user: user,
...
app.get(
  "/user-dashboard/:userId/venue-enquiries/:enquirieId/payment-confirm",
  sessionCheck,
  async function (req, res) {
    ...
    try {
      await VenueDashboard.updateOne(
        {
          userID: event.userID,
          ...
          budget: event.budget,
          guestNumber: event.guestQuantity,
          venueSpace: event.space,
        },
        {
          paymentStatus: true,
        }
...
app.get(
  "/user-dashboard/:userId/vendor-enquiries/:enquirieId/pay",
  sessionCheck,
  async function (req, res) {
    const EnquirieID = req.params.enquirieId;
    const UserID = req.params.userId;
    ...
    try {
      user = await VendorDashboard.findOne({
        userID: UserID,
        spaceID: event.spaceID,
      });
    } catch (err) {
    ...
    res.render("userDashboardVendorBillPage", {
      VendorID: vendor._id,
      user: user,
      event: event,
      vendor: vendor,
...
app.get(
  "/user-dashboard/:userId/vendor-enquiries/:enquirieId/payment-confirm",
  sessionCheck,
  async function (req, res) {
    //If payment done then copy to Active Events and set Paymemt Status to Done in both User and Vendor Dashboard
    const EnquirieID = req.params.enquirieId;
    ...
    try {
      await VendorDashboard.updateOne(
        {
          userID: event.userID,
...
app.get(
  "/user-dashboard/:userId/venue-enquiries",
  sessionCheck,
  async function (req, res) {
    const UserID = req.params.userId;
    ...
    res.render("userDashboardVenuePage", {
      UserID: UserID,
      enquiries: enquiries,
    });
  }
...
app.get(
  "/user-dashboard/:userId/settings/edit",
  sessionCheck,
  async function (req, res) {
    const UserID = req.params.userId;
...
app.get(
  ...
  async function (req, res) {
    ...
    try {
      active = await VenueDashboard.findOne({
        accepted: true,
        venueID: VenueID,
      });
    } catch (err) {
    ...
    try {
      number_2 = await VenueDashboard.find({
        accepted: true,
        venueID: VenueID,
      });
    } catch (err) {
...
app.get(
  "/venue-dashboard/:venueId/active-events",
  venueSessionCheck,
  async function (req, res) {
    const VenueID = req.params.venueId;
    ...
    res.render("venueDashboardEventsPage", {
      VenueID: VenueID,
      enquiries: enquiries,
    });
  }
...
app.get(
  "/venue-dashboard/:venueId/customers",
  venueSessionCheck,
  async function (req, res) {
    ...
    res.render("venueDashboardCustomerPage", {
      VenueID: VenueID,
      enquiries: enquiries,
    });
  }
...
app.get(
  "/venue-dashboard/:venueId/customers/:enquirieId/decline",
  venueSessionCheck,
  async function (req, res) {
    const VenueID = req.params.venueId;
    const EnquirieID = req.params.enquirieId;
...
app.get(
  "/venue-dashboard/:venueId/customers/:enquirieId/accept",
  venueSessionCheck,
  async function (req, res) {
    const EnquirieID = req.params.enquirieId;
    ...
    res.render("venueDashboardBillPage", {
      VenueID: venue._id,
      event: event,
      venue: venue,
...
app.get(
  "/venue-dashboard/:venueId/spaces",
  venueSessionCheck,
  async function (req, res) {
    const VenueID = req.params.venueId;
    ...
    res.render("venueDashboardSpacesPage", {
      VenueID: VenueID,
      spaces: spaces,
    });
  }
...
app.get(
  "/venue-dashboard/:venueId/spaces/add",
  venueSessionCheck,
  async function (req, res) {
    const VenueID = req.params.venueId;
...
app.get(
  "/venue-dashboard/:venueId/spaces/:spaceId/edit",
  venueSessionCheck,
  async function (req, res) {
    const VenueID = req.params.venueId;
    ...
    res.render("venueDashboardSpaceForm", {
      VenueID: VenueID,
      editing: true,
      space: space,
    });
...
app.get(
  "/venue-dashboard/:venueId/spaces/:spaceId/delete",
  venueSessionCheck,
  async function (req, res) {
    const VenueID = req.params.venueId;
    const spaceId = req.params.spaceId;
...
app.get(
  "/venue-dashboard/:venueId/settings",
  venueSessionCheck,
  async function (req, res) {
    const VenueID = req.params.venueId;
...
app.get(
  "/venue-dashboard/:venueId/settings/edit",
  venueSessionCheck,
  async function (req, res) {
    const VenueID = req.params.venueId;
    ...
    res.render("venueDashboardEditSettings", {
      VenueID: VenueID,
      Venue: venue,
    });
  }
...
app.get(
  ...
  async function (req, res) {
    ...
    try {
      active = await VendorDashboard.findOne({
        accepted: true,
        vendorID: VendorID,
      });
    } catch (err) {
    ...
    try {
      enquirie = await VendorDashboard.findOne({
        accepted: false,
        vendorID: VendorID,
      });
    } catch (err) {
    ...
    res.render("vendorDashboardPage", {
      VendorID: VendorID,
      active: active,
      enquirie: enquirie,
      currentUser: req.session.user,
...
app.get(
  "/vendor-dashboard/:vendorId/active-events",
  vendorSessionCheck,
  async function (req, res) {
    const VendorID = req.params.vendorId;
    ...
    res.render("vendorDashboardEventsPage", {
      VendorID: VendorID,
      enquiries: enquiries,
    });
  }
...
app.get(
  "/vendor-dashboard/:vendorId/customers",
  vendorSessionCheck,
  async function (req, res) {
    // Display Customer Enquiries
    ...
    res.render("vendorDashboardCustomerPage", {
      VendorID: VendorID,
      enquiries: enquiries,
    });
  }
...
app.get(
  "/vendor-dashboard/:vendorId/customers/:enquirieId/decline",
  vendorSessionCheck,
  async function (req, res) {
...
app.get(
  "/vendor-dashboard/:vendorId/customers/:enquirieId/accept",
  vendorSessionCheck,
  async function (req, res) {
    const EnquirieID = req.params.enquirieId;
    ...
    res.render("vendorDashboardBillPage", {
      VendorID: vendor._id,
      event: event,
      vendor: vendor,
      currentDate: currentDate,
...
app.get(
  "/vendor-dashboard/:vendorId/details",
  vendorSessionCheck,
  async function (req, res) {
    const VendorID = req.params.vendorId;
    ...
    res.render("vendorDashboardDetailsPage", {
      VendorID: VendorID,
      vendor: vendor,
    });
  }
...
app.get(
  "/vendor-dashboard/:vendorId/details/edit",
  vendorSessionCheck,
  async function (req, res) {
    const VendorID = req.params.vendorId;
    ...
    res.render("vendorDashboardDetailsEditPage", {
      VendorID: VendorID,
      vendor: vendor,
    });
  }
...
app.get(
  "/vendor-dashboard/:vendorId/help",
  vendorSessionCheck,
  function (req, res) {
    const VendorID = req.params.vendorId;
...
app.get(
  "/vendor-dashboard/:vendorId/settings",
  vendorSessionCheck,
  async function (req, res) {
    const VendorID = req.params.vendorId;
    ...
    res.render("vendorDashboardSettings", {
      VendorID: VendorID,
      Vendor: vendor,
    });
  }
...
app.get(
  "/vendor-dashboard/:vendorId/settings/edit",
  vendorSessionCheck,
  async function (req, res) {
    const VendorID = req.params.vendorId;
    ...
    res.render("vendorDashboardEditSettings", {
      VendorID: VendorID,
      Vendor: vendor,
    });
  }
...
app.post(
  "/vendors/:vendorService/list/:vendorId",
  sessionCheck,
  async function (req, res) {
    ...
    res.redirect(
      "/vendors/" + req.params.vendorService + "/list/" + req.params.vendorId
    );
  }
);
...
app.get("/vendors", function (req, res) {
  if (req.session.user) {
    res.render("vendorSelectionPage", {
      currentUser: req.session.user,
      UserID: req.session.user._id,
    });
  } else {
...
app.post("/venues/:spaceId/getquote", async function (req, res) {
  ...
  try {
    venue = await Venue.findOne({
      venue_name: space.venue_name,
      venue_address: space.venue_address,
    });
  } catch (err) {
    console.log(err);
  }
...
app.get(
  "/vendors/:vendorService/list/:vendorId/getquote",
  sessionCheck,
  async function (req, res) {
    const requestedVendorId = req.params.vendorId;
